...

{
  programs.fish = {
    ...
    shellAbbrs = {
      ...
      cleanfnm = "rm -rf $FNM_LIBRARY/node-versions/.downloads";
    };
    ...
    shellInit = ''
      ...
      set -gx FNM_LIBRARY "$HOME/.local/share/fnm"
      ...
      test -d $FNM_LIBRARY; and fish_add_path $FNM_LIBRARY
      ...
      # Set NODE_PATH after fnm has run
